...
//	public List<String> getUserEmails();
	...
	@Query("select u.userId, u.fName, u.lName, b.bookingId, b.seatID, s.floorNo, s.buildingId from user u join booking b on u.userId=b.userID join seat s on s.seatId=b.seatID")
